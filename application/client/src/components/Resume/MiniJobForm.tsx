// src/components/Resume/MiniJobForm.tsx
...
export type JobDraft = {
  ...
  description?: string;
  // dummy fields to satisfy downstream shapes (ignored by backend transformer)
  _id?: string;
  createdAt?: string;
  updatedAt?: string;
};
...
export default function MiniJobForm({
  ...
  const validateField = (
    ...
    switch (name) {
      case "jobTitle":
        ...
        else if (String(value).length > 150) error = "Job title must be 150 characters or less";
        break;

      case "company":
        if (!String(value || "").trim()) error = "Company is required";
        else if (String(value).length > 150) error = "Company must be 150 characters or less";
        break;
      ...
      case "location":
        if (String(value || "").length > 150) error = "Location must be 150 characters or less";
        break;
      ...
      case "jobPostingUrl":
        if (value && !String(value).match(/^https?:\/\/.+/)) error = "Enter a valid URL";
        break;

      case "description":
        if (String(value || "").length > 2000) error = "Description must be 2000 characters or less";
        break;
    }
  ...
  const setField = (name: keyof JobDraft, value: string) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    fields.forEach((f) => {
      const err = validateField(f, form[f], f === "salaryMin" ? form.salaryMax : form.salaryMin);
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              />
              {errors.jobTitle && <p className="text-sm text-red-600 -mt-2 mb-2">{errors.jobTitle}</p>}
            </div>
            ...
            <div>
              ...
              />
              {errors.company && <p className="text-sm text-red-600 -mt-2 mb-2">{errors.company}</p>}
            </div>
            ...
            <div>
              ...
              {errors.industry && <p className="text-sm text-red-600 -mt-2 mb-2">{errors.industry}</p>}
            </div>
            ...
            <div>
              ...
              {errors.type && <p className="text-sm text-red-600 -mt-2 mb-2">{errors.type}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Remote or Newark, NJ"
              />
              {errors.location && <p className="text-sm text-red-600 -mt-2 mb-2">{errors.location}</p>}
            </div>
            ...
            <div>
              ...
              />
              {errors.salaryMin && <p className="text-sm text-red-600 -mt-2 mb-2">{errors.salaryMin}</p>}
            </div>
            ...
            <div>
              ...
              />
              {errors.salaryMax && <p className="text-sm text-red-600 -mt-2 mb-2">{errors.salaryMax}</p>}
            </div>
          ...
          <div>
            ...
            />
            {errors.description && <p className="text-sm text-red-600 -mt-2 mb-2">{errors.description}</p>}
          </div>
