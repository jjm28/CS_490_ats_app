...
export default function ChronologicalPreview(props: Props) {
  ...
  return (
    ...
    >
      {/* HEADER: name + contact fixed at top */}
      ...
      <div className="space-y-4 px-6 pb-5 pt-3">
        {order.map((sectionId) => {
          ...
          // EDUCATION – uses institution, fieldOfStudy, graduationDate
          ...
          // PROJECTS – uses name, role, technologies, outcomes
