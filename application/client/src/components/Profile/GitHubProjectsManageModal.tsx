// components/Profile/GitHubProjectsManageModal.tsx
...
interface GitHubProjectsManageModalProps {
  isOpen: boolean;
  onClose: () => void;
}

const GitHubProjectsManageModal: React.FC<GitHubProjectsManageModalProps> = ({
  isOpen,
  onClose,
}) => {
  const token = useMemo(
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40">
      <div className="w-full max-w-5xl px-4 max-h-[90vh] overflow-y-auto py-6">
        <Card>
          ...
          {loading ? (
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-stone-700">
                Connect your GitHub account from your Profile Dashboard to
                manage and feature your projects.
              </p>
            </div>
          ) : (
            <>
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  <p className="text-xs text-stone-600">
                    Choose which repositories appear on your Profile Dashboard
                    (up to 6).
                  </p>
                </div>
                <Button
              ...
              {repos.length === 0 && (
                <p className="text-sm text-stone-700">
                  No repositories found. Try refreshing from GitHub on your
                  Profile Dashboard.
                </p>
              )}
...
export default GitHubProjectsManageModal;
